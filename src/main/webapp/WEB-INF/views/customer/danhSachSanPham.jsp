...
<body>
   ...
   <div class="linked-type-products">
    ...
    <div class="products" id="normal-products">
        <div class="type-products" id="normal-type-products">
            <div class="title-products"><h3>Thịt heo các loại</h3></div>
            <ul class="title-type-products">
    ...
    <div class="products" id="normal-products">
        <div class="type-products" id="normal-type-products">
            <div class="title-products"><h3>Thịt gà, thịt vịt</h3></div>
            <ul class="title-type-products">
       ...
       <div class="list-products">
        <!-- star item -->
        <div class="items">
            <c:forEach items="${ListType3}" var="a" begin="0" end="3" >
                	<div class="product">
                       	<div class="img-product">
                            <a href="${base }/chitietsanpham/${a.id}"><img src="${base }/upload/${a.anh_san_pham}"></a>
                        </div>
        ...
        <!-- end item -->
                         <!-- star item -->
        <div class="items">
            <c:forEach items="${ListType3}" var="a" begin="4" end="7" >
                	<div class="product">
                       	<div class="img-product">
                            <a href="${base }/chitietsanpham/${a.id}"><img src="${base }/upload/${a.anh_san_pham}"></a>
                        </div>
